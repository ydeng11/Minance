...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record6<Integer, Integer, String, String, String, Long> {
    ...
    @Override
    public Row6<Integer, Integer, String, String, String, Long> valuesRow() {
    ...
    @Override
    public AccountsRecord value6(Long value) {
        setInitBalance(value);
        return this;
    }

    @Override
    public AccountsRecord values(Integer value1, Integer value2, String value3, String value4, String value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsRecord(Integer accountId, Integer bankId, String bankName, String accountName, String accountType, Long initBalance) {
        super(Accounts.ACCOUNTS);
