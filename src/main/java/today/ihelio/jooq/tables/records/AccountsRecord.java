...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record5<Integer, Integer, String, String, String> {
    ...
    @Override
    public AccountsRecord values(Integer value1, Integer value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsRecord(Integer accountId, Integer bankId, String bankName, String accountName, String accountType) {
        super(Accounts.ACCOUNTS);
