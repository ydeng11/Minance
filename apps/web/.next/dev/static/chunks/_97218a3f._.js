...
"[project]/apps/web/src/app/settings/migration/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MigrationSettingsPage() {
    ...
    const [migrationPath, setMigrationPath] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [migrationFile, setMigrationFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [migrationReport, setMigrationReport] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    async function runMigration() {
        ...
        try {
            if (migrationPath.trim()) {
                ...
                const sqliteBase64 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["readFileAsBase64"])(migrationFile);
                const result = await api.migration.run({
            ...
            setMessage(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"] ? error.message : "Migration failed.");
        } finally{
            setIsRunning(false);
        }
    }
...
_s(MigrationSettingsPage, "s95iIT94DH/CxQO329NV/6/oF2c=", false, function() {
    return [
...
_c = MigrationSettingsPage;
var _c;
__turbopack_context__.k.register(_c, "MigrationSettingsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_97218a3f._.js.map