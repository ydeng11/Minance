...
function DashboardPage() {
    ...
    const [categoryView, setCategoryView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("granular");
    ...
    const trendBars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[trendBars]": ()=>{
            return (overview?.trend || []).slice(-6).map({
                "DashboardPage.useMemo[trendBars]": (entry)=>{
                    const maxSpend = Math.max(1, ...(overview?.trend || []).map({
                        "DashboardPage.useMemo[trendBars].maxSpend": (item)=>item.spend
                    }["DashboardPage.useMemo[trendBars].maxSpend"]));
                    const maxIncome = Math.max(1, ...(overview?.trend || []).map({
                        "DashboardPage.useMemo[trendBars].maxIncome": (item)=>item.income
                    }["DashboardPage.useMemo[trendBars].maxIncome"]));
                    return {
                        ...entry,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: loading ? Array.from({
                            ...
                            lineNumber: 227,
                            columnNumber: 17
                        }, this) : trendBars.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardPage, "z2Nu0EwPlTlPTWK8tdzEqEHKMpc=", false, function() {
    return [
