...
function TransactionsPage() {
    ...
    const categoryFilterOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[categoryFilterOptions]": ()=>{
            if (categoryView === "granular") {
                return categories.map({
                    "TransactionsPage.useMemo[categoryFilterOptions]": (entry)=>entry.name
                }["TransactionsPage.useMemo[categoryFilterOptions]"]);
            }
            const fromTransactions = transactions.map({
                "TransactionsPage.useMemo[categoryFilterOptions].fromTransactions": (entry)=>entry.category_coarse || ""
            }["TransactionsPage.useMemo[categoryFilterOptions].fromTransactions"]).filter(Boolean);
            const fromOverview = (overview?.topCategories || []).map({
                "TransactionsPage.useMemo[categoryFilterOptions].fromOverview": (entry)=>entry.category
            }["TransactionsPage.useMemo[categoryFilterOptions].fromOverview"]);
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    ...
                                                    categoryFilterOptions.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: entry,
                                                            children: entry
                                                        }, entry, false, {
                                                            fileName: "[project]/apps/web/src/app/transactions/page.tsx",
...
_s(TransactionsPage, "qoKPiGtVphLNfR9Wt3hJ/8qB98c=", false, function() {
    return [
