...
export async function runAssistantQuery(
  ...
  // Confirmation flow: use dedicated API endpoints (POST /v1/assistant/actions/:id/confirm|cancel)
  // Text-based confirmation is deprecated — removed. All confirmations go through the API.
