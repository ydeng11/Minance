...
- [ ] 3.1 Wave A: Migrate `apps/web` JavaScript-family files to `.tsx`/`.ts` and update imports/references.
- [ ] 3.2 Run Wave A quality gates (typecheck, lint, tests/build as applicable) and fix regressions.
